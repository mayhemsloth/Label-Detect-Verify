...
class Training:
    ...
    epochs: int = 1000       # total number of epochs to train for. If you don't like performance, try to train longer, or label more high quality data for low performance classes
...
class Inference:
    ...
    img_input_size: int = 1600            # should be the same as the training input image size for best performance
